...
function caclculateAverage(...args) {
  ...
  for (let i = 0; i < args.length; i++) {
    if (typeof args[i] === "number") {
      ...
      notNumber.push(args[i]);
    }
  }
  return `Середнє значення: ${sum / count}, не числа: ${notNumber}`;
}
// console.log(caclculateAverage(1, 2, 3, "a", 5, "m", 7, "t", 9, 10));
...
// console.log(sumOfNeighbours(someArr)); // [33, 45, 39, 17, 25, 27, 29]
